document.addEventListener('DOMContentLoaded', () => {
  const jsonDataPath = '../one-hundred-thousand-years-of-qi-refining/one-hundred-thousand-years-of-qi-refining.json';
  ...
  fetch(jsonDataPath)
    ...
    .then(data => {
      const seriesName = data['one-hundred-thousand-years-of-qi-refining'][0];
