document.addEventListener('DOMContentLoaded', () => {
  const jsonDataPath = '../donghua-divine-lord-of-the-heavens/donghua-divine-lord-of-the-heavens.json';
  ...
  fetch(jsonDataPath)
    ...
    .then(data => {
      const seriesName = data['donghua-divine-lord-of-the-heavens'][0];
