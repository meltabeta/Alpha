document.addEventListener('DOMContentLoaded', () => {
  const jsonDataPath = '../donghua-the-king-s-avatar-season-1/donghua-the-king-s-avatar-season-1.json';
  ...
  fetch(jsonDataPath)
    ...
    .then(data => {
      const seriesName = data['donghua-the-king-s-avatar-season-1'][0];
