document.addEventListener('DOMContentLoaded', () => {
  const jsonDataPath = '../donghua-the-king-s-avatar-season-2/donghua-the-king-s-avatar-season-2.json';
  ...
  fetch(jsonDataPath)
    ...
    .then(data => {
      const seriesName = data['donghua-the-king-s-avatar-season-2'][0];
